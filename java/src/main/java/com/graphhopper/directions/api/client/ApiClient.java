...
import com.graphhopper.directions.api.client.auth.HttpBasicAuth;
import com.graphhopper.directions.api.client.auth.ApiKeyAuth;
import com.graphhopper.directions.api.client.auth.OAuth;
import com.graphhopper.directions.api.client.auth.OAuth.AccessTokenListener;
import com.graphhopper.directions.api.client.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://graphhopper.com/api/1";
    if(!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
